...
\begin{table}[H]
	...
	\makebox[\textwidth]{  % Para centrar una tabla más ancha que la página definida.
		\begin{tabular}{|c|c|c|c|c|}
			...
			Búsqueda de información para el estado del arte &	Jefe de Proyecto & 40 & 80 & 3200 \euro\\
			Desarrollo aplicación Android autenticación 2FA &	Programador & 32 & 50 & 1600 \euro\\
			Desarrollo simulación NFC aleatorio & Programador & 20 & 50 & 1000 \euro\\
			Pruebas & Ingeniero de Pruebas & 8 & 60 & 480 \euro\\
			Supervisión del Proyecto & Jefe de Proyecto & 4 & 80 & 320 \euro\\ \hline\hline
			\multicolumn{4}{|c|}{Total} & \multicolumn{1}{c|}{6600 \euro}\\ \hline
		\end{tabular}
	}
\end{table}
...
\begin{table*}[ht]
	...
	\makebox[\textwidth]{  % Para centrar una tabla ancha.
		\begin{tabular}{|l|l|}
			...
			Subtotal  &  8070,25 \\
			IVA (21\%) & 1694,75 \\ \hline \hline
			Total Proyecto & \textbf{9765 \euro} \\ \hline
	\end{tabular}}
\end{table*}
