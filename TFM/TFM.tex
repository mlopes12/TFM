...
\begin{table*}[ht]
		...
		\makebox[\textwidth]{
			\begin{tabular}{|l|l|l|}
				...
				\multicolumn{3}{|l|}{}\\
				\multicolumn{3}{|p{16cm}|}{Se evaluarán diferentes aspectos en general de la seguridad de los postes del coche eléctrico. En primer lugar se realizará un estado del arte para conocer su situación actual y la de algunas de las tecnologías asociadas a ello, como RFID o NFC, además del protocolo de comunicaciones. Posteriormente se explotará una de las vulnerabilidades relacionadas con ellos como es la suplantación de identidad, robando la etiqueta RFID con la que un usuario accede de forma legítima a la recarga de su vehículo eléctrico. Para eviarrlo, además, se propondrán algunas soluciones a través de su sistema de gestión basadas en el doble factor de autenticación (2FA) y las tecnologías NFC y, también, la unión de las dos tecnologías. Finalmente se aportarán unas conclusiones y algunas líneas futuras para continuar en sucesivos trabajos.} \\ 
				\multicolumn{3}{|l|}{}\\
				\hline
...
\begin{table}[H]
	...
	\makebox[\textwidth]{  % Para centrar una tabla más ancha que la página definida.
		\begin{tabular}{|c|c|c|c|c|}
			...
			Desarrollo simulación NFC aleatorio & Programador (D I) & 30 & 11,84 & 355,20 \euro\\
...
\bibitem{SeguridadSocial} \item Bases y tipos de cotización 2022, Régimen General de la Seguridad Social, (\href{https://www.seg-social.es/wps/portal/wss/internet/Trabajadores/CotizacionRecaudacionTrabajadores/36537})
\bibitem{ConvenioTIC} \item XVII Convenio colectivo estatal de empresas de consultoría, y estudios de
