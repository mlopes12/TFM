...
\begin{itemize}
\item En la prueba de concepto se ha podido descubrir como es relativamente sencillo el poder robar el valor de una etiqueta RFID y poder hacernos pasar por un usuario legítimo para poder recargar sin permiso.
...
Repitiendo una gran cantidad de veces estas pruebas se puede apreciar que estos sistemas aportam mucha más seguridad al proceso de recarga de un vehículo eléctrico.
...
\bibitem{CodigoPenal} \item Ley Orgánica 10/1995, de 23 de noviembre, del Código Penal (\href{https://www.boe.es/eli/es/lo/1995/11/23/10/con})
