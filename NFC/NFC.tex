...
\begin{table}[H]
	...
	\makebox[\textwidth]{  % Para centrar una tabla más ancha que la página definida.
		\begin{tabular}{|c|c|c|c|c|}
			...
			Búsqueda de información para el estado del arte &	Jefe de Proyecto & 40 & 140 & 5600 \euro\\
			Desarrollo aplicación Android &	Programador Junior & 20 & 70 & 1400 \euro\\
			Desarrollo simulación NFC aleatorio & Programador Junior & 8 & 120 & 960 \euro\\
			Pruebas & Ingeniero de Pruebas & 8 & 80 & 160 \euro\\
			Supervisión del Proyecto & Jefe de Proyecto & 4 & 140 & 560 \euro\\ \hline\hline
			\multicolumn{4}{|c|}{Total} & \multicolumn{1}{c|}{8680 \euro}\\ \hline
		\end{tabular}
	}
\end{table}
...
\begin{table*}[ht]
	...
	\makebox[\textwidth]{  % Para centrar una tabla ancha.
		\begin{tabular}{|l|l|}
			...
			Costes de personal & 8680  \\
			Costes de hardware  & 1470,25   \\ \hline
			Subtotal  &  10150,25 \\
			IVA (21\%) & 2131,55 \\ \hline \hline
			Total Proyecto & \textbf{12281,80 \euro} \\ \hline
	\end{tabular}}
\end{table*}
